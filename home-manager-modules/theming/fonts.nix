{ pkgs, ... }: {
  home.file = {
    ".local/share/fonts/zenbones-mono".source = pkgs.fetchzip {
      url =
        "https://github.com/zenbones-theme/zenbones-mono/releases/download/v2.400/Zenbones-Brainy-TTF.zip";
    ...
    ".local/share/fonts/BabelStoneRunicElderFuthark.ttf".source =
      pkgs.fetchurl {
        url =
          "https://babelstone.co.uk/Fonts/Download/BabelStoneRunicElderFuthark.ttf";
        sha256 = "sha256-awYvgb6O07ouxwqg2OgomDia1j4jmVFwyAr7oSacNws=";
      };

    ".local/share/fonts/tahoma.ttf".source = pkgs.fetchurl {
      url =
        "https://gitlab.winehq.org/wine/wine/-/raw/master/fonts/tahoma.ttf?ref_type=heads&inline=false";
    ...
    ".local/share/fonts/SF-Pro-Text-Regular.otf".source = pkgs.fetchurl {
      url =
        "https://raw.githubusercontent.com/sahibjotsaggu/San-Francisco-Pro-Fonts/master/SF-Pro-Text-Regular.otf";
    ...
    ".local/share/fonts/SF-Pro-Rounded-Regular.otf".source = pkgs.fetchurl {
      url =
        "https://raw.githubusercontent.com/sahibjotsaggu/San-Francisco-Pro-Fonts/master/SF-Pro-Rounded-Regular.otf";
      sha256 = "sha256-law3sWLJMN9jjLnLFJw2+HHL8fQpZsyYuA63/uGtyW4=";
    };

    ".local/share/fonts/SF-Mono-Regular.otf".source = pkgs.fetchurl {
      url =
        "https://raw.githubusercontent.com/supercomputra/SF-Mono-Font/master/SFMono-Regular.otf";
