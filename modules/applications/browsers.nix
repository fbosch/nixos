{
  flake.modules.homeManager.applications =
    ...
    in
    {
      ...
      systemd.user.services.zen-browser-profile-sync = lib.mkIf (!useProfileSyncDaemon) {
        Unit = {
      ...
      systemd.user.timers.zen-browser-profile-sync-periodic = lib.mkIf (!useProfileSyncDaemon) {
      ...
      systemd.user.services.zen-browser-profile-sync-periodic = lib.mkIf (!useProfileSyncDaemon) {
        Unit.Description = "Periodic sync of Zen Browser profile from RAM to disk";
