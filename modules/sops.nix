          ...
          home.activation.generateFishSecrets =
            let
              ...
              secretsMap = {
                ...
                NPM_TOKEN = hmConfig.sops.secrets.npm-personal-access-token.path;
              };
            ...
            lib.hm.dag.entryAfter [ "writeBoundary" ] ''
              ...
              EOF
                            ...
                            $DRY_RUN_CMD install -m 0600 /dev/null ${hmConfig.home.homeDirectory}/.npmrc
                            cat > ${hmConfig.home.homeDirectory}/.npmrc << EOF
