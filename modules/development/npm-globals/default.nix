{
  flake.modules.homeManager.development =
    ...
    let
      ...
      approveNodePackageBuilds = mkPnpmGlobalsCommand {
        name = "pnpm-global-approve-builds";
        requiredFile = "pnpm-workspace.yaml";
        missingHint = "Run this from the npm-globals checkout containing pnpm-workspace.yaml.";
        beforeInstall = ''
        ...
        successMessage = ''
          echo ""
          echo "Build approvals applied. Review and commit pnpm-workspace.yaml + pnpm-lock.yaml in: $npm_globals_dir"
        '';
      };
