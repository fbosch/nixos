...
Home Manager activation also installs from the committed lockfile. Activation is non-blocking: failed installs warn and can be retried with `home-manager switch` or `pnpm-global-install`.
