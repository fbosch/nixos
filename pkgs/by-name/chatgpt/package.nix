...
stdenvNoCC.mkDerivation (
  ...
  in
  {
    ...
    postPatch = ''
      ...
      # The Pets UI forces installation from an absent bundled skill payload.
      grep -aFq 'forceReinstall:!0,hostId:Oe,installRoot:null,repoPath:st,skillId:ot' usr/lib/chatgpt/resources/app.asar
      sed -i 's/forceReinstall:!0,hostId:Oe,installRoot:null,repoPath:st,skillId:ot/forceReinstall:!1,hostId:Oe,installRoot:null,repoPath:st,skillId:ot/' usr/lib/chatgpt/resources/app.asar
    '';
    ...
    installPhase = ''
      ...
      mkdir -p "$out/share/chatgpt"
        ...
        cp -R ${hatchPet}/skills/.curated/hatch-pet "$out/share/chatgpt/hatch-pet"
    ...
    postFixup = ''
      wrapProgram "$out/bin/chatgpt" \
        ...
        --set CHATGPT_HATCH_PET_SOURCE "$out/share/chatgpt/hatch-pet" \
        --prefix PATH : ${
          lib.makeBinPath [
            nodejs-slim
            xdg-utils
